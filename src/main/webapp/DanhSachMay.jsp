				...
				<div class="container">
					<div class="row bg-dark p-3">
						...
						<div class="col-6 text-right">
							...
							<a href="controllermay" style="background-color: green;" type="submit"
					...
					<div style="margin: 0 auto; width: 550px">
						<h3 align="left">Show Danh Sach May</h3>
						<form action="controllermay" method="post">
							<div class="row">
									...
									<tbody>
										<c:forEach items="${listMay}" var="may">
											<tr class="row-table">
												...
												<td>${may.viTri}</td>
												<td>${may.trangThai}</td>
												<td><a href="updateMay?id=${may.maMay}"
													class="btn text-warning"> <i class="fa fa-edit"></i>
												</a> <a href="DeleteMay?id=${may.maMay}" class="btn text-danger">
