...
public class MultiKeySDM implements Serializable {
	...
	@Column(name = "MaKH", columnDefinition = "varchar(10)", insertable = false, updatable = false)
	private String key2;

	@Column(name = "NgayBatDauSuDung", columnDefinition = "date")
